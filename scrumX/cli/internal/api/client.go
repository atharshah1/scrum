...
if err := c.request(cfg.APIURL, http.MethodPost, "/auth/login", "", "", body, &out); err != nil {
return User{}, TokenPair{}, err
}
...
if err := c.request(cfg.APIURL, http.MethodPost, "/auth/refresh", "", "", authRefreshRequest{RefreshToken: refreshToken}, &out); err != nil {
return TokenPair{}, err
}
return out.Data, nil
}
...
if err := resp.Unmarshal(&structured); err == nil && structured.Error.Message != "" {
return structured.Error.Message
}
var unstructured map[string]any
if err := resp.Unmarshal(&unstructured); err == nil {
